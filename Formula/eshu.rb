class Eshu < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "fdccc5167bffb41fe56369ea420ae1f361796eaa63006ef53ca89679d2ff701f"
    end

    on_intel do
      url "https://proxy-function-241114592952.europe-west1.run.app/download/v#{version}/eshu-#{version}.darwin-amd64.tar.gz"
      sha256 "fdb1f0f3f94f87b4e0b43ccbb33606722ad5d3710702e004aab24dc8f5a75b51"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "f7079550e8f67aff7a7aa822197d1f42a664edf2661607dda352cd767ad5372f"
    end

    on_intel do
      url "https://proxy-function-241114592952.europe-west1.run.app/download/v#{version}/eshu-#{version}.linux-amd64.tar.gz"
      sha256 "4a6201e63fa749c05224795ac7ecb577ab34cc6cced27bafce7040e1967f2b1a"
    end
  end
